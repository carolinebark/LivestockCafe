...
# Skapa en första buffert som representerar mellanrummet, t.ex., 10 meter ut från polygonen
initialBuffer_lok <- st_buffer(polygon_lok, dist = 10)

#Buffert utanför glappet 
extendedBuffer_lok <- st_buffer(initialBuffer_lok, dist = 200)

# Skapa yttre buffertområdet genom att subtrahera initialBuffer_lok från extendedBuffer_lok
outerBufferArea_lok <- st_difference(extendedBuffer_lok, initialBuffer_lok)

# Ändra tillbaka till WGS84
...
# Create the "outside buffert by taking the diffrence
...
# Konvertera Year till ett numeriskt format
erosion_in_out_long$Year <- as.numeric(as.character(erosion_in_out_long$Year))

# Skapa en tidvariabel baserat på Year
